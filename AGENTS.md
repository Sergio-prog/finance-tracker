...
- **`skills/finance-tracker-api/SKILL.md`** — describes both the HTTP API and the CLI wrapper.
  An agent should read this to learn how to interact with the tracker.
- When you change API behaviour (new endpoints, changed responses, different auth, etc.),
  update the skill file and keep `packages/finances-cli/` in sync.
